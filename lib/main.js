...
function showQuery() {
  ...
  const url = "https://neuvoo.com/services/api-new/search?ip=1.1.1.1&useragent=123asd&k="+ keywords.replace(/ /g, "%20") + "&l=" + location.replace(/ /g, "%20") + "&country=us&contenttype=all&limit=100&format=json&publisher=PUBID&cpcfloor=1&subid=10101&jobdesc=1";
